...
sim_anealing = SimulatedAnnealing(initial_solution = init_solution, conditions=Conditions(100, 0.1, 0.2, 0.97, 100, Annealing.linear), is_first_and_last_element_static=True)

sim_anealing.optimize()
calculate_value(init_solution, True)
calculate_value(sim_anealing.best_solution, True)
