...
class PlotterModule(containers.DeclarativeContainer):
    ...
    plotter_position_service = providers.Singleton(PlotterPositionService, repository=plotter_repository)
    ...
    project_service = providers.Singleton(ProjectService, plotter_repository=plotter_repository, project_repository = project_repository)
